...
namespace BidUp_App
{
    ...
    partial void OnProductIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Auction_Notification", Storage="_Notifications", ThisKey="AuctionID", OtherKey="AuctionID")]
    ...
    partial void OnDynamicDataChanging(string value);
    partial void OnDynamicDataChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DynamicData", DbType="NVarChar(MAX)")]
		public string DynamicData
		{
			...
			set
			{
				if ((this._DynamicData != value))
				{
					this.OnDynamicDataChanging(value);
					this.SendPropertyChanging();
					this._DynamicData = value;
					this.SendPropertyChanged("DynamicData");
					this.OnDynamicDataChanged();
				}
			}
		}
    ...
    partial void OnBidderIDChanging(int value);
    ...
    partial void OnIsReadChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_BidderID", DbType="Int NOT NULL")]
		public int BidderID
		{
			get
			{
			...
			set
			{
				if ((this._BidderID != value))
				{
					...
					this.OnBidderIDChanging(value);
					this.SendPropertyChanging();
					this._BidderID = value;
					this.SendPropertyChanged("BidderID");
					this.OnBidderIDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Auction_Notification", Storage="_Auction", ThisKey="AuctionID", OtherKey="AuctionID", IsForeignKey=true)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Notification", Storage="_User", ThisKey="BidderID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
			...
			set
			{
							...
							|| (this._User.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						value.Notifications.Add(this);
						this._BidderID = value.UserID;
					}
					else
					{
						this._BidderID = default(int);
					}
					this.SendPropertyChanged("User");
				}
			}
    ...
    partial void OnCreatedAtChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Notification", Storage="_Notifications", ThisKey="UserID", OtherKey="BidderID")]
		public EntitySet<Notification> Notifications
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Wallet", Storage="_Wallets", ThisKey="UserID", OtherKey="UserID")]
    ...
    partial void OnLastUpdatedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Wallet", Storage="_User", ThisKey="UserID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
